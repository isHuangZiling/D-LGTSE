import pprint 
import argparse 
from libs.trainer_dlgtse_stage3 import SiSnrTrainer 
...
if __name__ == "__main__":
    ...
    parser.add_argument("--checkpoint",
                        type=str,
                        default='/node/hzl/expriment2025/exp_twospk_noise/cpt/debug',
                        help="Directory to dump models")
    parser.add_argument("--resume", 
                        type=str,
                        default="/node/hzl/expriment2025/exp_twospk_noise/cpt2/stage2/best.pt.tar",
