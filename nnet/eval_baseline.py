...
from model_CIENet_mDPTNet import FreqNet
...
def evaluate(args, model_file, logger):
    ...
    with th.no_grad():
        for data in dataloader:
            mix = th.tensor(data['mix'], dtype=th.float32, device=device).unsqueeze(0)
...
if __name__ == '__main__':
    ...
    best_log_file = os.path.join(args.checkpoint, "eval_best_libri2mix.log")
